	...
	<view class="preview">
		<swiper circular="true" :current="currentIndex" @change="swiperChange">
			<swiper-item v-for="(item, index) in classList" :key="item._id">
				<image v-if="readImages.includes(index)" @click="maskChange" :src="item.picurl" mode="aspectFill">
				</image>
			</swiper-item>
		</swiper>
		...
		<view class="mask" v-if="maskState">
			...
			<view class="footer">
				...
				<view class="box" @click="clickScore" v-if="currentInfo">
					...
					<view class="content" v-if="currentInfo">
						...
						<view class="row">
							...
							<text selectable class="value">
								...
								<uni-rate
									:value="currentInfo.userScore ? currentInfo.userScore : currentInfo.score"></uni-rate>
